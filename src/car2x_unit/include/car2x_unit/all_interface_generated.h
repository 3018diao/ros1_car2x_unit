...
struct FacilityLayerTransmission FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const Gos::FacilityLayerMessage *msg() const {
    return GetPointer<const Gos::FacilityLayerMessage *>(VT_MSG);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct FacilityLayerTransmissionBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_msg(::flatbuffers::Offset<Gos::FacilityLayerMessage> msg) {
...
inline ::flatbuffers::Offset<FacilityLayerTransmission> CreateFacilityLayerTransmission(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<Gos::FacilityLayerMessage> msg = 0) {
...
struct FacilityLayerMessage FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const Gos::CAMessage *cam_msg() const {
    return GetPointer<const Gos::CAMessage *>(VT_CAM_MSG);
  }
  const Gos::CPMessage *cpm_msg() const {
    return GetPointer<const Gos::CPMessage *>(VT_CPM_MSG);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct FacilityLayerMessageBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_cam_msg(::flatbuffers::Offset<Gos::CAMessage> cam_msg) {
    fbb_.AddOffset(FacilityLayerMessage::VT_CAM_MSG, cam_msg);
  }
  void add_cpm_msg(::flatbuffers::Offset<Gos::CPMessage> cpm_msg) {
    fbb_.AddOffset(FacilityLayerMessage::VT_CPM_MSG, cpm_msg);
  }
...
inline ::flatbuffers::Offset<FacilityLayerMessage> CreateFacilityLayerMessage(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<Gos::CAMessage> cam_msg = 0,
    ::flatbuffers::Offset<Gos::CPMessage> cpm_msg = 0) {
...
struct CPMessage FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyTable(header()) &&
           VerifyField<uint64_t>(verifier, VT_GENERATION_DELTA_TIME, 8) &&
           VerifyOffsetRequired(verifier, VT_MGMT_CONTAINER) &&
...
struct CPMessageBuilder {
  ...
  ::flatbuffers::Offset<CPMessage> Finish() {
    ...
    fbb_.Required(o, CPMessage::VT_MGMT_CONTAINER);
...
struct CpmPayload FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffsetRequired(verifier, VT_ORIGINATING_STATIONS_CONTAINER) &&
           verifier.VerifyTable(originating_stations_container()) &&
           VerifyOffsetRequired(verifier, VT_SENSOR_INFORMATION_CONTAINER) &&
           verifier.VerifyTable(sensor_information_container()) &&
           VerifyOffsetRequired(verifier, VT_PERCEPTION_REGION_CONTAINER) &&
...
struct CpmPayloadBuilder {
  ...
  ::flatbuffers::Offset<CpmPayload> Finish() {
    ...
    fbb_.Required(o, CpmPayload::VT_ORIGINATING_STATIONS_CONTAINER);
    fbb_.Required(o, CpmPayload::VT_SENSOR_INFORMATION_CONTAINER);
    fbb_.Required(o, CpmPayload::VT_PERCEPTION_REGION_CONTAINER);
    return o;
  }
};
...
struct MessageRateRange FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffsetRequired(verifier, VT_MESSAGE_RATE_MIN) &&
           verifier.VerifyTable(message_rate_min()) &&
           VerifyOffsetRequired(verifier, VT_MESSAGE_RATE_MAX) &&
...
struct MessageRateRangeBuilder {
  ...
  ::flatbuffers::Offset<MessageRateRange> Finish() {
    ...
    fbb_.Required(o, MessageRateRange::VT_MESSAGE_RATE_MIN);
    fbb_.Required(o, MessageRateRange::VT_MESSAGE_RATE_MAX);
    return o;
  }
};
...
struct OriginatingRSUContainer FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffsetRequired(verifier, VT_ROAD_SEGMENT) &&
...
struct OriginatingRSUContainerBuilder {
  ...
  ::flatbuffers::Offset<OriginatingRSUContainer> Finish() {
    ...
    fbb_.Required(o, OriginatingRSUContainer::VT_ROAD_SEGMENT);
...
struct PerceptionRegionBuilder {
  ...
  ::flatbuffers::Offset<PerceptionRegion> Finish() {
    ...
    fbb_.Required(o, PerceptionRegion::VT_PERCEPTION_REGION_SHAPE);
    return o;
  }
};
...
struct PerceivedObject FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_ACCELERATION = 12,
    VT_ANGLES = 14,
    VT_Z_ANGULAR_VELOCITY = 16,
    VT_LOWER_TRIANGULAR_CORRELATION_MATRICES = 18,
    VT_OBJECT_DIMENSION_Z = 20,
    VT_OBJECT_DIMENSION_Y = 22,
    VT_OBJECT_DIMENSION_X = 24,
    VT_OBJECT_AGE = 26,
    VT_OBJECT_PERCEPTION_QUALITY = 28,
    VT_SENSOR_ID_LIST = 30,
  ...
  const Gos::Acceleration3dWithConfidence *acceleration() const {
    return GetPointer<const Gos::Acceleration3dWithConfidence *>(VT_ACCELERATION);
  }
  const Gos::EulerAnglesWithConfidence *angles() const {
    return GetPointer<const Gos::EulerAnglesWithConfidence *>(VT_ANGLES);
  }
  const Gos::CartesianAngularVelocityComponent *z_angular_velocity() const {
    return GetPointer<const Gos::CartesianAngularVelocityComponent *>(VT_Z_ANGULAR_VELOCITY);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<Gos::LowerTriangularPositiveSemidefiniteMatrix>> *lower_triangular_correlation_matrices() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<Gos::LowerTriangularPositiveSemidefiniteMatrix>> *>(VT_LOWER_TRIANGULAR_CORRELATION_MATRICES);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_Z_ANGULAR_VELOCITY) &&
           verifier.VerifyTable(z_angular_velocity()) &&
           VerifyOffset(verifier, VT_LOWER_TRIANGULAR_CORRELATION_MATRICES) &&
           verifier.VerifyVector(lower_triangular_correlation_matrices()) &&
           verifier.VerifyVectorOfTables(lower_triangular_correlation_matrices()) &&
           ...
           VerifyOffsetRequired(verifier, VT_MAP_POSITION) &&
...
struct PerceivedObjectBuilder {
  ...
  void add_acceleration(::flatbuffers::Offset<Gos::Acceleration3dWithConfidence> acceleration) {
    fbb_.AddOffset(PerceivedObject::VT_ACCELERATION, acceleration);
  }
  void add_angles(::flatbuffers::Offset<Gos::EulerAnglesWithConfidence> angles) {
    fbb_.AddOffset(PerceivedObject::VT_ANGLES, angles);
  }
  void add_z_angular_velocity(::flatbuffers::Offset<Gos::CartesianAngularVelocityComponent> z_angular_velocity) {
    fbb_.AddOffset(PerceivedObject::VT_Z_ANGULAR_VELOCITY, z_angular_velocity);
  }
  void add_lower_triangular_correlation_matrices(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<Gos::LowerTriangularPositiveSemidefiniteMatrix>>> lower_triangular_correlation_matrices) {
    fbb_.AddOffset(PerceivedObject::VT_LOWER_TRIANGULAR_CORRELATION_MATRICES, lower_triangular_correlation_matrices);
  }
  ...
  ::flatbuffers::Offset<PerceivedObject> Finish() {
    ...
    fbb_.Required(o, PerceivedObject::VT_MAP_POSITION);
    return o;
  }
};
...
inline ::flatbuffers::Offset<PerceivedObject> CreatePerceivedObject(
    ...
    ::flatbuffers::Offset<Gos::Acceleration3dWithConfidence> acceleration = 0,
    ::flatbuffers::Offset<Gos::EulerAnglesWithConfidence> angles = 0,
    ::flatbuffers::Offset<Gos::CartesianAngularVelocityComponent> z_angular_velocity = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<Gos::LowerTriangularPositiveSemidefiniteMatrix>>> lower_triangular_correlation_matrices = 0,
  ...
  builder_.add_lower_triangular_correlation_matrices(lower_triangular_correlation_matrices);
...
inline ::flatbuffers::Offset<PerceivedObject> CreatePerceivedObjectDirect(
    ...
    ::flatbuffers::Offset<Gos::EulerAnglesWithConfidence> angles = 0,
    ::flatbuffers::Offset<Gos::CartesianAngularVelocityComponent> z_angular_velocity = 0,
    const std::vector<::flatbuffers::Offset<Gos::LowerTriangularPositiveSemidefiniteMatrix>> *lower_triangular_correlation_matrices = nullptr,
    ::flatbuffers::Offset<Gos::ObjectDimension> object_dimension_z = 0,
    ::flatbuffers::Offset<Gos::ObjectDimension> object_dimension_y = 0,
    ::flatbuffers::Offset<Gos::ObjectDimension> object_dimension_x = 0,
    uint32_t object_age = 0,
    ...
    ::flatbuffers::Offset<Gos::MapPosition> map_position = 0) {
  auto lower_triangular_correlation_matrices__ = lower_triangular_correlation_matrices ? _fbb.CreateVector<::flatbuffers::Offset<Gos::LowerTriangularPositiveSemidefiniteMatrix>>(*lower_triangular_correlation_matrices) : 0;
  auto sensor_id_list__ = sensor_id_list ? _fbb.CreateVector<uint32_t>(*sensor_id_list) : 0;
  ...
  return Gos::CreatePerceivedObject(
      ...
      angles,
      z_angular_velocity,
      lower_triangular_correlation_matrices__,
      object_dimension_z,
      object_dimension_y,
      object_dimension_x,
      object_age,
...
struct ObjectClass FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_VRU_SUB_CLASS = 6,
    VT_GROUP_SUB_CLASS = 8,
    VT_OTHER_SUB_CLASS = 10
  };
  ...
  const Gos::VruProfileAndSubprofile *vru_sub_class() const {
    return GetPointer<const Gos::VruProfileAndSubprofile *>(VT_VRU_SUB_CLASS);
  }
  const Gos::VruClusterInformation *group_sub_class() const {
    return GetPointer<const Gos::VruClusterInformation *>(VT_GROUP_SUB_CLASS);
  }
  const Gos::OtherSubClass *other_sub_class() const {
    return GetPointer<const Gos::OtherSubClass *>(VT_OTHER_SUB_CLASS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_VEHICLE_SUB_CLASS, 4) &&
           VerifyOffset(verifier, VT_VRU_SUB_CLASS) &&
           verifier.VerifyTable(vru_sub_class()) &&
           VerifyOffset(verifier, VT_GROUP_SUB_CLASS) &&
           verifier.VerifyTable(group_sub_class()) &&
           VerifyOffset(verifier, VT_OTHER_SUB_CLASS) &&
           verifier.VerifyTable(other_sub_class()) &&
           verifier.EndTable();
  }
};
...
struct ObjectClassBuilder {
  ...
  void add_vru_sub_class(::flatbuffers::Offset<Gos::VruProfileAndSubprofile> vru_sub_class) {
    fbb_.AddOffset(ObjectClass::VT_VRU_SUB_CLASS, vru_sub_class);
  }
  void add_group_sub_class(::flatbuffers::Offset<Gos::VruClusterInformation> group_sub_class) {
    fbb_.AddOffset(ObjectClass::VT_GROUP_SUB_CLASS, group_sub_class);
  }
  void add_other_sub_class(::flatbuffers::Offset<Gos::OtherSubClass> other_sub_class) {
    fbb_.AddOffset(ObjectClass::VT_OTHER_SUB_CLASS, other_sub_class);
  }
...
inline ::flatbuffers::Offset<ObjectClass> CreateObjectClass(
    ...
    ::flatbuffers::Offset<Gos::VruProfileAndSubprofile> vru_sub_class = 0,
    ::flatbuffers::Offset<Gos::VruClusterInformation> group_sub_class = 0,
    ::flatbuffers::Offset<Gos::OtherSubClass> other_sub_class = 0) {
  ObjectClassBuilder builder_(_fbb);
  builder_.add_other_sub_class(other_sub_class);
  builder_.add_group_sub_class(group_sub_class);
  builder_.add_vru_sub_class(vru_sub_class);
